...
4) Увеличить статистику посещения определнной страницы, например, фишиного сайта, чтобы выводить его в топ поисковых запросов
5) Перевод денег.
6) Шантажирование пользователя методами социальной инженирии.
7) И т.д.

## Защита
### Основные меры

GET-запросы в веб-приложении не должны выполнять каких-либо действий от лица пользователя.
