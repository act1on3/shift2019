...
3) заголовое Referer (наличие и адрес прихода запроса)
...
## Ущерб
Злоумышленник имеет возможность совершать действия, о который пользователь не знает совсем. Например, можно подписаться на какую-либо страницу, отправить сообщение, поставить лайк, отправить деньги (если не предусмотрено подтверждение паролем).  
