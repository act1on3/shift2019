...
На рисунке 2 показан результат перехода по видоизмененной ссылке, показанной на рисунке 1. Какьвидно на рисунке 2 – пользователем, в браузере которого были сохранены cookie и, следовательно, он был залогинен на данном сайте, был отправлен запрос против его воли. 
